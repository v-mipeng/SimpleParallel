# coding=utf-8
#!Copied from fairscale.nn.model_parallel.mappings.py
# Adjust _GatherFromModelParallelRegion for Tensor parallel
...
class _GatherFromModelParallelRegionBak(torch.autograd.Function):
    """Gather the input from model parallel region and concatinate.
    I find it has some error for gradient backpropagation.
    I fixed it with the following version _GatherFromModelParallelRegion
    """
